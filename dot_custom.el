(require-package 'casual-avy)
(require-package 'casual-bookmarks)
(require-package 'casual-calc)
(require-package 'casual-dired)
(require-package 'casual-ibuffer)
(require-package 'casual-info)
(require-package 'casual-re-builder)
(require-package 'spacious-padding)
